...
# 성공 이미지 추가
# 만약 파일명을 안 고치셨다면 "smile.png.png"라고 적어야 합니다!
st.image("smile.png", caption="분석 완료! 수고하셨습니다 👍", width=200)

# width=200 : 사진 크기를 적당히(200픽셀) 조절하는 옵션입니다.
# 너무 크면 width를 100으로 줄이고, 작으면 300으로 늘려보세요.


# 로또 1개랑 재미난 거 or 무역 1개 만들어서 올려보기(로또는 어제 한 거 그대로 복붙)